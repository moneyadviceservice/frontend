...
gem 'cost_calculator_builder', git: 'git@github.com:moneyadviceservice/cost_calculator_builder', branch: '9756-jquery-upgrade'
...
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: '9827_with_jq_upgrades'
gem 'pacs', '3.5.2'
