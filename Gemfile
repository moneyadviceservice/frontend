...
gem 'feedback', '~> 0.4.0'
#gem 'mortgage_calculator', '~> 3.2.0'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator', branch: '9302_links-target-blank'
gem 'payday_loans_intervention', '~> 1.7.0'
gem 'pensions_calculator', '~> 1.6.0'
