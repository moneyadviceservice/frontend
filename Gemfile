...
gem 'site_search', :source => 'http://gems.dev.mas.local/'
# Tools
...
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: 'preview'
gem 'debt_and_mental_health', '~> 1.6.0'
# gem 'debt_free_day_calculator', path: '../debt_free_day_calculator'
gem 'debt_free_day_calculator', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator.git', branch: 'preview'
gem 'debt_test', '~> 1.9.0'
gem 'decision_trees', '~> 2.3.0'
gem 'feedback', '~> 0.5.1'
# gem 'mortgage_calculator', '~> 3.15.0'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: 'ntt'
