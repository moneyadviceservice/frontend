...
gem 'mas-cms-client', path: '../mas-cms-client', require: 'mas/cms', branch: 'articles-api' #git: 'git@github.com:moneyadviceservice/mas-cms-client', branch: 'articles-api', require: 'mas/cms'
gem 'meta-tags', '~> 2.4'
gem 'mysql2'
gem 'newrelic_rpm'
gem 'nokogiri'
...
gem 'debt_and_mental_health', '~> 1.3.0'
gem 'debt_free_day_calculator', '~> 2.3.0'
gem 'debt_test', '~> 1.6.0'
gem 'decision_trees', '~> 2.1.0'
gem 'feedback', '~> 0.4.0'
gem 'mortgage_calculator', '~> 1.9.0'
gem 'payday_loans_intervention', '~> 1.6.0'
gem 'pensions_calculator', '~> 1.3.2'
gem 'quiz', '~> 1.2.0', source: 'http://gems.dev.mas.local'
gem 'rio', '1.13.0', source: 'http://gems.dev.mas.local'
gem 'savings_calculator', '~> 1.8.0'
gem 'timelines', '~> 1.4.0'
