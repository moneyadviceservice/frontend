define(['log', 'jquery'], function (Global, $) {
  ...
  Collapsible.prototype._modifyButtonHTML = function (i) {
    var trigger = this.sections[i].trigger, target = this.sections[i].target, icon = (this.o.showIcon) ? trigger.prepend(this.o.headingIcon.replace('{{txt}}', this.o.textString.show_this_section)) : '';
