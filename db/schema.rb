...
ActiveRecord::Schema.define(version: 20170302112627) do
  ...
  create_table "universal_credit_questionnaires", force: :cascade do |t|
    t.boolean  "received_first_payment"
    t.integer  "single_or_in_couple",                   limit: 4
    t.boolean  "worried_about_claiming_as_couple"
    t.integer  "housing_circumstances",                 limit: 4
    t.integer  "pay_bills_directly",                    limit: 4
    t.boolean  "have_loans_or_debts"
    t.integer  "pay_for_energy",                        limit: 4
    t.integer  "have_children",                         limit: 4
    t.boolean  "care_for_someone"
    t.boolean  "working"
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    t.integer  "behind_with_rent_or_mortgage_payments", limit: 4
  end
