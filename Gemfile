...
gem 'baby_cost_calculator', '~> 0.3.0', git: 'git@github.com:moneyadviceservice/baby_cost_calculator.git', branch: '7549-upgrade-rails'
gem 'budget_planner', '~> 4.2.0'
gem 'car_cost_tool', '~> 1.1.0'
gem 'contribution_calculator', '~> 0.0.1'
gem 'cost_calculator_builder', '~> 0.1.12'
gem 'cutback_calculator', '~> 0.11.0', git: 'git@github.com:moneyadviceservice/cutback-calculator.git', branch: '7551-cutback-calculator'
gem 'debt_advice_locator', '~> 2.3.0'
gem 'debt_and_mental_health', '~> 1.1.0', git: 'git@github.com:moneyadviceservice/debt_and_mental_health.git', branch: '7522-rails-upgrade'
gem 'debt_free_day_calculator', '~> 2.2.0'
gem 'debt_test', '~> 1.5.0', git: 'git@github.com:moneyadviceservice/debt_test.git', branch: '7548-rails-upgrade'
