...
gem 'site_search',  git: 'git@github.com:moneyadviceservice/site_search.git', ref: 'f3aba3d88ac7daab81f55a10e03456e6003ff77c' 
# Tools
gem 'action_plans', '~> 5.0.0'
gem 'advice_plans', '~> 4.0.1'
gem 'agreements', '~> 2.4.0'
gem 'baby_cost_calculator', '~> 0.3.0'
gem 'budget_planner', '~> 5.5.0'
...
gem 'debt_and_mental_health', git: 'git@github.com:moneyadviceservice/debt_and_mental_health.git', branch: '10121-upgrade-to-ruby253', ref: '87e705ac38278a35eb38119f1f0a0b3e5ab4a05c'
