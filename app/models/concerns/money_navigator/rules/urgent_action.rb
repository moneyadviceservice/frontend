          ...
          content_rules: [
            # Show if Q1A2 plus Q0A1 or Q0A3 or Q0A4 plus any of Q4A2, Q4A3, Q6A4, Q6A5, Q9A1-A11, Q10A1 BUT NOT IF HAVE ALSO SELECTED Q4A4, Q4A1, Q6A6, Q7A1-A9, Q10A3
            {
              triggers: [
                { q0: %w[a1 a3 a4] },
                { q1: ['a2'] },
                { q4: %w[a2 a3], q6: %w[a4 a5], q9: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11], q10: ['a1'] },
                { q4: %w[a4 a1], q6: ['a6'], q7: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9], q10: ['a3'] }
              ],
            ...
            # Show if Q1A2 (self employed flag) plus Q0A2, plus any of these Q3A1, Q4A2, Q4A3, Q6A4, Q6A5, Q9A1-A11, Q10A1  BUT NOT IF HAVE ALSO SELECTED Q4A1, Q4A4, Q6A6, Q7A1-A9, Q10A3
            {
              triggers: [
                { q0: ['a2'] },
                { q1: ['a2'] },
                { q3: ['a1'], q4: %w[a2 a3], q6: %w[a4 a5], q9: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11], q10: ['a1'] },
                { q4: %w[a4 a1], q6: ['a6'], q7: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9], q10: ['a3'] }
              ],
              mask: [MASK_SOME + MASK_ALL + MASK_SOME + MASK_NONE,
                     MASK_SOME + MASK_ALL + MASK_ALL + MASK_NONE,
            ...
            # Show if any of these Q4A2, Q4A3, Q6A4, Q6A5, Q9A1-A11, Q10A1  BUT NOT IF HAVE ALSO SELECTED Q4A4, Q4A1, Q6A6, Q7A1-A9, Q10A3
            {
              triggers: [
                ...
                { q6: %w[a4 a5] },
                { q10: ['a1']},
                { q7: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9], q9: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11]  },
                { q4: %w[a1], q6: ['a6'] }
              ],
              mask: [
                MASK_SOME + MASK_SOME + MASK_SOME + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_SOME + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_SOME + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_SOME + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_ALL + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_ALL + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_ALL + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_SOME + MASK_ALL + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_SOME + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_SOME + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_SOME + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_SOME + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_ALL + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_ALL + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_ALL + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_SOME + MASK_ALL + MASK_ALL + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_SOME + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_SOME + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_SOME + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_SOME + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_ALL + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_ALL + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_ALL + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_SOME + MASK_ALL + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_SOME + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_SOME + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_SOME + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_SOME + MASK_ALL + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_ALL + MASK_SOME + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_ALL + MASK_SOME + MASK_SOME + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_ALL + MASK_ALL + MASK_ALL + MASK_NONE,
                MASK_ALL + MASK_ALL + MASK_ALL + MASK_ALL + MASK_SOME + MASK_NONE,
              ],
          ...
          content_rules: [
            {
              triggers: [
                { q0: %w[a1 a3 a4] },
                { q1: 'a2' },
                { q3: ['a2'], q4: ['a1'], q5: ['a3'], q6: ['a6'], q7: %w[a1 a2 a3 a4 a5 a6 a7 a8 a9], q10: ['a3'] }
              ],
