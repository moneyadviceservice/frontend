...
# gem 'debt_advice_locator', '3.9.1'
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: '10687_Add-spinner-to-Search-button', ref: 'f69f02c'
