...
gem 'action_plans', git: 'git@github.com:moneyadviceservice/action_plans.git', branch: '12085_Jump-links'
...
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: '12274_mortgage_calculator_link_update'
# gem 'pacs', '~> 3.13.0'
...
gem 'rio', git: 'git@github.com:moneyadviceservice/rio.git', branch: 'feature/ntt_moneyhelper_reskin'
