...
gem 'car_cost_tool', '~> 1.1.0', git: 'git@github.com:moneyadviceservice/car_cost_tool.git', branch: '7540-rails-4.2-upgrade'
...
gem 'debt_free_day_calculator', '~> 2.2.0', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator.git', branch: '7542-upgrade-rails-version'
gem 'debt_test'
