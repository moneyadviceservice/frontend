...
gem 'debt_advice_locator', '3.12.0'
...
# gem 'savings_calculator', '~> 1.10.1'
# gem 'savings_calculator', path: '../savings_calculator'
gem 'savings_calculator', git: 'git@github.com:moneyadviceservice/savings_calculator.git', branch: '10978_Update-link_best-savings-account'
gem 'timelines', '~> 1.7.0'
# gem 'universal_credit', '~> 4.1.1'
gem 'universal_credit', git: 'git@github.com:moneyadviceservice/universal_credit', branch: '10771_Urgent-Support-link'
gem 'wpcc', '2.8.1'
