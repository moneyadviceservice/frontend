...
gem 'timelines', '~> 1.5.0'
gem 'universal_credit', git: 'git@github.com:moneyadviceservice/universal_credit.git', ref: 'f0bfc42cd21a604479899972702957f749e001f6'
gem 'wpcc', '1.12.0'
