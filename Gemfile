...
gem 'budget_planner', git: 'git@github.com:moneyadviceservice/budget_planner', branch: '9952_Global-dropdown-styles'
gem 'car_cost_tool', '~> 1.3'
gem 'cost_calculator_builder', '~> 0.4.6'
gem 'cutback_calculator', '~> 0.12.0'
gem 'debt_advice_locator', '~> 2.10.0'
...
# gem 'pacs', '3.1.1'
gem 'pacs', git: 'git@github.com:moneyadviceservice/pacs', branch: '9952_Global-dropdown-styles'
gem 'payday_loans_intervention', '~> 1.7.0'
# gem 'pensions_calculator', '~> 1.10.1'
gem 'pensions_calculator', git: 'git@github.com:moneyadviceservice/pensions_calculator', branch: '9832-bar-options'
