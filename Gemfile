...
# gem 'dough-ruby', '~> 5.28'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: '9392_PopupTip-position'
...
gem 'car_cost_tool', git: 'git@github.com:moneyadviceservice/car_cost_tool.git', branch: '9886_Car-tool_positioning'
gem 'cost_calculator_builder', '~> 0.4.6'
gem 'cutback_calculator', '~> 0.12.0'
gem 'debt_advice_locator', '~> 2.8.6'
