...
var sWODomain = "";
var sWOChatstart = "https://webchat.moneyadviceservice.org.uk/chat/chatstart.htm";
var sWODepartment = "";
var sWOSkillNames = "";
var sWOLanguage = "";
...
function woAfterLoad() {
  ...
  function getImg() {
    var rTimer = 6000;
    var pUrl = iWOGateway + "/poll.gif?d=webchat.moneyadviceservice.org.uk&stamp=" + (new Date()).getTime();
    if (iWOSession != "") {
      pUrl += "&u=" + iWOSession
    }
    imgPoll.src = pUrl;
...
function inviteSound() {
  ...
  if (t != null) {
    t.src = iWOGateway + "/" + playSound + "?domain=webchat.moneyadviceservice.org.uk";
...
function startInvite() {
  ...
  var ofsY;
  var iUrl = iWOGateway + "/invite.gif?d=webchat.moneyadviceservice.org.uk&stamp=" + (new Date()).getTime();
...
function startChat(event) {
  if (event.clientX < locX + imgW - closeX || event.clientY > locY + closeY) {
    this.chatWindow = window.open("https://webchat.moneyadviceservice.org.uk/chat/chatstart.htm?domain=webchat.moneyadviceservice.org.uk", "Chat", "width=484,height=361");
...
function getParams() {
  ...
  ifme.src = iWOGateway + "/params.js?d=webchat.moneyadviceservice.org.uk&stamp=" + (new Date()).getTime() + ((iWOSession != "") ? "&u=" + iWOSession : "");
