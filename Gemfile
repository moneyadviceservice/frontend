...
# Tools
gem 'action_plans', git: 'git@github.com:moneyadviceservice/action_plans.git', branch: 'year-end-updates'
...
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: 'fix-package-path'
gem 'debt_and_mental_health', '~> 1.6.0'
gem 'debt_free_day_calculator', '~> 4.0.0'
gem 'debt_test', '~> 1.9.0'
gem 'decision_trees', '~> 2.3.0'
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: 'year-end-updates'
gem 'pacs', '~> 4.0.2'
