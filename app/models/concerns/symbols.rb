...

        {
          ...
          content_rules: [
            ...
            #Show if any of these Q4A2, Q4A3, Q6A4, Q6A5, Q9A1-A11, Q10A1  BUT NOT IF HAVE ALSO SELECTED Q4A4, Q4A1, Q6A6, Q7A1-A9, Q10A3
            {
              ...
              #If the UX radio is changed to checkbox (multiple select) then the edge case of selecting all the MASK_SOME for the first 3 will
              #fail to trigger the content. Totally double-edgecase situation but worth keeping in mind. In this case the 4th trigger is a checkbox
              #so we need two masks to cater for the edgecase
              mask: [
