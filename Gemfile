...
gem 'budget_planner', git: 'git@github.com:moneyadviceservice/budget-planner', branch: 'budget-planner-redesign-master'
...
gem 'rio', git: 'git@github.com:moneyadviceservice/rio.git', branch: '7236_budget_2016_update', ref: '6d6d5c6'
