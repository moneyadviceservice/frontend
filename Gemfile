...
gem 'cream', '2.1.8'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: 'PostMessages_v5.43', ref: '7379fe1'
gem 'mas-cms-client', '1.20.1'
gem 'site_search', '0.3.0'
# Tools
gem 'action_plans', git: 'git@github.com:moneyadviceservice/action_plans.git', branch: 'feature/ntt_moneyhelper_reskin', ref: '74afc98'
...
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: '12218_Jump-links'
...
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: '12274_mortgage_calculator_link_update', ref: 'cc4280f'
...
gem 'pensions_calculator', git: 'git@github.com:moneyadviceservice/pensions_calculator.git', branch: 'feature/NTT_Rebased', ref: '6eda9b3'
...
gem 'universal_credit', git: 'git@github.com:moneyadviceservice/universal_credit.git', branch: '12225_Update-link'
