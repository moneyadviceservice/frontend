...
gem 'cream', '2.1.7'
#gem 'dough-ruby', '~> 5.29'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: 'fe-architecture'
...
# gem 'pacs', '3.0.0'
gem 'pacs', git: 'git@github.com:moneyadviceservice/pacs.git', branch: '9877-inline-defer-resize-spike'
