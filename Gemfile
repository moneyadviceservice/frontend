...
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator', branch: 'feature/mortgage-calc-reskin'
gem 'pacs', '3.11.0'
gem 'payday_loans_intervention', '~> 1.9.0'
# gem 'pensions_calculator', '~> 2.6.1'
# gem 'pensions_calculator', path: '../pensions_calculator'
gem 'pensions_calculator', git: 'git@github.com:moneyadviceservice/pensions_calculator', branch: 'feature/reskin-pensions-calc'
