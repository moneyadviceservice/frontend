...
# gem 'budget_planner', '~> 5.1.1'
gem 'budget_planner', git: 'git@github.com:moneyadviceservice/budget_planner', branch: '9320_Summary-page-text'
gem 'car_cost_tool', '~> 1.2.2'
gem 'cost_calculator_builder', '~> 0.4.5'
gem 'cutback_calculator', '~> 0.12.0'
# gem 'debt_advice_locator', '~> 2.5.3'
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator', branch: '8789_DAL-i-icon'
gem 'debt_and_mental_health', '~> 1.3.1'
# gem 'debt_free_day_calculator', '~> 2.3.6'
gem 'debt_free_day_calculator', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator', branch: '9319_loan-calc-meta'
gem 'debt_test', '~> 1.7.3'
gem 'decision_trees', '~> 2.1.0'
gem 'feedback', '~> 0.4.0'
# gem 'mortgage_calculator', '~> 3.2.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator', branch: '9323_mortgage-calc-info-bug'
