...
gem 'action_plans', '~> 4.3.0', git: 'git@github.com:moneyadviceservice/action_plans.git', branch: '7607-rails-upgrade'
gem 'advice_plans', '~> 3.2.0'
gem 'agreements', '~> 2.1.0'
gem 'baby_cost_calculator', '~> 0.3.0'
gem 'budget_planner', '~> 4.2.0'
gem 'car_cost_tool', '~> 1.1.0'
gem 'contribution_calculator', '~> 0.1.0', git: 'git@github.com:moneyadviceservice/contribution_calculator.git', branch: '7550-rails-upgrade'
...
gem 'payday_loans_intervention', '~> 1.5.0', git: 'git@github.com:moneyadviceservice/payday_loans_intervention.git', branch: '7553-rails-upgrade'
