...
gem 'cream', '2.1.7'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: 'fe-architecture', ref: '3149d2e98cb150e27a0db7b0169b053b215f4cf6'
...
gem 'pacs', git: 'git@github.com:moneyadviceservice/pacs.git', branch: '9877-inline-defer-resize-spike', ref: 'd590b76d9c652f5f4886c7dcadc79f55257e20a8'
