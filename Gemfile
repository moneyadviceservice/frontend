...
gem 'action_plans', git: 'git@github.com:moneyadviceservice/action_plans', branch: '10228_Update-JQuery'
gem 'advice_plans', '~> 4.0.1'
gem 'agreements', '~> 2.4.0'
gem 'baby_cost_calculator', '~> 0.3.0'
# gem 'budget_planner', '~> 5.6.1'
gem 'budget_planner', git: 'git@github.com:moneyadviceservice/budget_planner', branch: '10232_Update-JQuery'
# gem 'car_cost_tool', '~> 1.4'
gem 'car_cost_tool', git: 'git@github.com:moneyadviceservice/car_cost_tool', branch: '10233_update-jquery'
gem 'cost_calculator_builder', '~> 1.0.0'
gem 'cutback_calculator', '~> 0.13.0'
# gem 'debt_advice_locator', '~> 3.1.0'
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator', branch: '10235_Update-JQuery'
gem 'debt_and_mental_health', '~> 1.4.0'
# gem 'debt_free_day_calculator', '~> 3.0.0'
gem 'debt_free_day_calculator', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator', branch: '10237_update-jquery', ref: 'd032510'
gem 'debt_test', '~> 1.8.0'
...
####
gem 'pacs', '3.4.0', git: 'git@github.com:moneyadviceservice/pacs', branch: '10242-pacs-update-jquery'
...
# gem 'wpcc', '2.2.0'
gem 'wpcc', git: 'git@github.com:moneyadviceservice/wpcc', branch: '10250_Update-JQuery'
