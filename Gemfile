...
gem 'agreements', git: 'git@github.com:moneyadviceservice/agreements.git', branch: 'ms/upgrade-ruby-2-5-3', ref: 'fcba7f0'
gem 'baby_cost_calculator', '~> 0.3.0'
gem 'budget_planner', git: 'git@github.com:moneyadviceservice/budget_planner.git', branch: 'ms/upgrade-ruby-2-5-3', ref: 'd5806db'
