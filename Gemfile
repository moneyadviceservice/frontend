...
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: '9827/stamp-duty-scotland-ftb'
gem 'pacs', '3.3.0'
...
gem 'wpcc', git: 'git@github.com:moneyadviceservice/wpcc', branch: 'nty-base-branch'
