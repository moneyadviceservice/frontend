...
gem 'dotenv'
gem 'draper', '< 3'
gem 'dry-configurable', '< 0.8' # Remove when Frontend Ruby gets on ruby 2.5
gem 'faraday', '0.9.2'
...
gem 'pacs', git: 'git@github.com:moneyadviceservice/pacs.git', branch: 'ms/10197-remove-defaqto-v1-code', ref: '73bdfc9'
