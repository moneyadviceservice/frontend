...
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: 'ms/10127-upgrade-ruby-to-2-5-3', ref: '7456705'
...
# gem 'decision_trees', git: 'git@github.com:moneyadviceservice/decision_trees.git', branch: 'ms/bump-18n-js', ref: '0714747'
# gem 'feedback', '~> 0.4.0'
gem 'feedback', git: 'git@github.com:moneyadviceservice/feedback.git', branch: 'ms/10128-upgrade-to-ruby-2-5-3', ref: '04e163a'
