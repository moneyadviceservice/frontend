...
gem 'debt_free_day_calculator', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator', branch: '11920_Storage-Access-API', ref: '164ba02'
gem 'debt_test', '~> 1.9.0'
gem 'decision_trees', '~> 2.3.0'
gem 'feedback', '~> 0.5.1'
# gem 'mortgage_calculator', '~> 3.16.0'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: '11945_Holding-statement', ref: '0e2e3cc13d97f25826796ccdbec3b7581241586e'
gem 'pacs', '~> 3.13.0'
