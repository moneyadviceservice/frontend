...
gem 'cream', '2.1.7'
# gem 'dough-ruby', '~> 5.29'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: '10188_SDC_icon-misaligned'
...
gem 'feedback', '~> 0.4.0'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: 'ms/upgrade-ruby-2-5-3', ref: 'cb9f45d'
gem 'pacs', '3.2.0'
