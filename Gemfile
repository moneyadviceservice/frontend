...
# gem 'debt_advice_locator', '~> 3.10.0'
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator', branch: '10739_Fix-spinner-for-Use-current-location', ref: '9611b68'
gem 'debt_and_mental_health', '~> 1.6.0'
gem 'debt_free_day_calculator', '~> 3.1.0'
gem 'debt_test', '~> 1.9.0'
gem 'decision_trees', '~> 2.3.0'
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', '~> 3.8.2'
gem 'pacs', '3.10.0'
