...
#gem 'budget_planner', '~> 4.4.2'
gem 'budget_planner', git: 'git@github.com:moneyadviceservice/budget_planner.git', branch: 'data-dump-task'
...
gem 'rio', '1.10.0', source: 'http://gems.dev.mas.local'
