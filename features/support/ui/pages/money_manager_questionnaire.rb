...
module UI::Pages
  class MoneyManagerQuestionnaire < UI::Page
    set_url '/en/tools/money-manager/questionnaire'
    ...
    element :submit,
            "form[action='/en/tools/money-manager/questionnaire'] button[type='submit']"
  end
end
