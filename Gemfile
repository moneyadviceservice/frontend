...
gem 'savings_calculator', git: 'git@github.com:moneyadviceservice/savings_calculator.git', branch: '10978_Update-links_target-syndicated'
# gem 'savings_calculator', path: '../savings_calculator'
# gem 'savings_calculator', '~> 1.10.0'
gem 'timelines', '~> 1.7.0'
