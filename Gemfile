...
# gem 'debt_advice_locator', '3.8.0'
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: '10647_Search-function', ref: 'e853be1ac5b7545cb767770098f10bafd30eec28'
