...
gem 'mas-cms-client', '1.20.1', git: 'git@github.com:moneyadviceservice/mas-cms-client.git', branch: 'TP-11734-upgrade-json'
gem 'site_search', '0.3.0'
# Tools
gem 'action_plans', '~> 5.5.0'
gem 'advice_plans', '~> 4.1.1', git: 'git@github.com:moneyadviceservice/advice_plans.git', branch: 'TP-11733-update-kaminari'
