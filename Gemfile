...
gem 'budget_planner', '~> 4.2.0', git: 'git@github.com:moneyadviceservice/budget_planner.git', branch: '7539-rails-upgrade'
gem 'car_cost_tool', '~> 1.1.0'
gem 'contribution_calculator', '~> 0.0.1'
gem 'cost_calculator_builder', '~> 0.1.12'
gem 'cutback_calculator', '~> 0.10'
gem 'debt_advice_locator', '~> 2.3', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: '7541-rails-upgrade'
gem 'debt_and_mental_health', '~> 1.0.1'
gem 'debt_free_day_calculator', '~> 2.2.0'
gem 'debt_test'
gem 'decision_trees', '~> 2.0.0'
gem 'feedback', '~> 0.3.1'
gem 'mortgage_calculator', '~> 1.5.0', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: '7544-rails-upgrade'
