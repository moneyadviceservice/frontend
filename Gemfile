...
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: 'ms/10270-local-landing-pages', ref:'e55455a'
...
gem 'wpcc', git: 'git@github.com:moneyadviceservice/wpcc.git', branch: 'ms/10292-remove-results-step-up-block', ref: 'f435cc7'
