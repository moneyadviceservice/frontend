...
# Tools
gem 'action_plans', github: 'moneyadviceservice/action_plans', branch: 'adobe-data'
gem 'advice_plans', '~> 4.1.1'
gem 'agreements', '~> 2.5.0'
gem 'budget_planner', github: 'moneyadviceservice/budget_planner', branch: 'adobe-data'
...
gem 'debt_free_day_calculator', github: 'moneyadviceservice/debt_free_day_calculator', branch: 'adobe-data'
gem 'debt_test', '~> 1.9.0'
...
gem 'pensions_calculator', github: 'moneyadviceservice/pensions_calculator', branch: 'adobe-data'
gem 'puma'
