...
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator.git', branch: '12736_Security_High-XSS-Script-issue'
gem 'debt_and_mental_health', '~> 1.6.0'
gem 'debt_free_day_calculator', '~> 3.2.0'
gem 'debt_test', '~> 1.9.0'
gem 'decision_trees', '~> 2.3.0'
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', '~> 3.18.1'
gem 'pacs', '~> 3.13.0'
gem 'payday_loans_intervention', '~> 1.9.0'
gem 'pensions_calculator', '~> 2.7.2'
