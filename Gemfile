...
# gem 'dough-ruby', '~> 5.25'
# gem 'dough-ruby', path: '../dough'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough', branch: '8647_tooltip-icon'
gem 'draper', '< 3'
gem 'faraday', '0.9.2'
...
gem 'cost_calculator_builder', '~> 0.4.4'
gem 'cutback_calculator', '~> 0.12.0'
gem 'debt_advice_locator', '~> 2.5.0'
gem 'debt_and_mental_health', '~> 1.3.1'
# gem 'debt_free_day_calculator', '~> 2.3.1'
# gem 'debt_free_day_calculator', path: '../debt_free_day_calculator'
gem 'debt_free_day_calculator', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator', branch: '8678/9_Calculators_SEO_Update-headings'
gem 'debt_test', '~> 1.7.3'
gem 'decision_trees', '~> 2.1.0'
gem 'feedback', '~> 0.4.0'
# gem 'mortgage_calculator', '~> 1.10.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator', branch: '8698_stamp-duty-update'
...
# gem 'wpcc', '1.11.12'
# gem 'wpcc', path: '../wpcc'
gem 'wpcc', git: 'git@github.com:moneyadviceservice/wpcc', branch: '8647_tooltip-icon'
