...
FactoryBot.define do
  factory :questions, class: Questions do
    ...
    factory :S1_H2_stepchange_debt, traits: [:country, :urgent_stepchange_action]
    factory :S1_H3_self_employed_debt_advice, traits: [:country, :urgent_debtline_action]
    factory :S1_H4_urgent_pension_advice, traits: [:country, :pension]
    ...
    trait :S1_H2_stepchange_redirect_to_self_employed_debt_advice_answers do
      ...
      q2 { answers_with_entropy('q2', [], nil)  }
      q3 { answers_with_entropy('q3', [], nil)  }
      q4 { answers_with_entropy('q4', ['a2', 'a3'], nil )}
      q5 { answers_with_entropy('q5', [], nil)  }
