...
gem 'debt_test', '~> 1.8.0'
gem 'decision_trees', git: 'git@github.com:moneyadviceservice/decision_trees.git', branch: 'ms/bump-locked-gem-dependencies', ref: '9b59f0a'
# gem 'decision_trees', '= 2.1.0.116', source: 'http://gems.dev.mas.local'
gem 'feedback', '~> 0.4.1'
