...
module Frontend
  class Application < Rails::Application
    ...
    config.chat_opening_hours.update("Apr 3, 2015", '10:00 AM', '10:00 PM')
    config.chat_opening_hours.closed("Apr 5, 2015")
    config.chat_opening_hours.update("Apr 6, 2015", '8:00 AM', '10:00 PM')
