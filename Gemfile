...
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator', branch: '9104_Translation-error'
gem 'payday_loans_intervention', '~> 1.7.0'
gem 'pensions_calculator', '~> 1.4.3'
gem 'quiz', '~> 1.2.0', source: 'http://gems.dev.mas.local'
gem 'rio', '1.19.1', source: 'http://gems.dev.mas.local'
