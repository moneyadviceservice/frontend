...
gem 'pensions_calculator', git: 'git@github.com:moneyadviceservice/pensions_calculator.git', branch: 'nty-base-branch', ref: '8a6cb28'
gem 'quiz', '~> 1.3.0', source: 'http://gems.dev.mas.local'
gem 'rio', git: 'git@github.com:moneyadviceservice/rio.git' , branch: 'nty-base-branch', ref: '31c4213'
gem 'savings_calculator', '1.9.0'
gem 'timelines', '~> 1.5.0'
gem 'universal_credit', '4.0.0'
gem 'wpcc', git: 'git@github.com:moneyadviceservice/wpcc.git', branch: 'nty-base-branch', ref: '6c737c4'
