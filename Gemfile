...
gem 'cost_calculator_builder', '~> 0.2.0', git: 'git@github.com:moneyadviceservice/cost_calculator_builder.git', branch: '7606-rails-upgrade'
...
gem 'debt_test', '~> 1.5.0'
gem 'decision_trees', '~> 2.1.0', git: 'git@github.com:moneyadviceservice/decision_trees.git', branch: '7543-rails-upgrade'
gem 'feedback', '~> 0.4.0'
...
gem 'savings_calculator', '~> 1.3.0', git: 'git@github.com:moneyadviceservice/savings_calculator.git', branch: '7547-rails-upgrade'
gem 'timelines', '~> 1.3.0'
