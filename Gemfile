...
gem 'action_plans', git: 'git@github.com:moneyadviceservice/action_plans.git', branch: '12054_Update_Links'
...
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: 'Stamp_Duty_Urgent_Changes_321'
# gem 'pacs', '~> 3.13.0'
...
gem 'savings_calculator', git: 'git@github.com:moneyadviceservice/savings_calculator.git', branch: '12032_Update_Links'
# gem 'timelines', '~> 1.7.1'
