...
gem 'debt_advice_locator', '~> 4.1.2'
gem 'debt_and_mental_health', '~> 1.6.0'
gem 'debt_free_day_calculator', '~> 4.0.1'
gem 'debt_test', '~> 1.9.0'
gem 'decision_trees', '~> 2.3.0'
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: 'stamp-duty-banner'
gem 'pacs', '~> 4.0.4'
gem 'payday_loans_intervention', '~> 1.9.0'
gem 'pensions_calculator', '~> 3.0.3'
