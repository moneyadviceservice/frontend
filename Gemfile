...
gem 'pensions_calculator', git: 'git@github.com:moneyadviceservice/pensions_calculator.git', branch: '10106-ruby-2.5.3', ref: 'c3dd8f6de0ae81c'
gem 'quiz', '~> 1.2.0', source: 'http://gems.dev.mas.local'
# gem 'rio', '1.20.0', source: 'http://gems.dev.mas.local'
gem 'rio', git: 'git@github.com:moneyadviceservice/rio.git', branch: '10133-upgrade-to-ruby2.5.3', ref: '44244ffb068a9d'
