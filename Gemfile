...
gem 'cutback_calculator', '~> 0.12.0', git: 'git@github.com:moneyadviceservice/cutback-calculator.git', branch: '7693-canonical-tags'
...
gem 'pensions_calculator', '~> 1.3.0', git: 'git@github.com:moneyadviceservice/pensions_calculator.git', branch: '7693-canonical-tags'
gem 'quiz', '~> 1.1.0', source: 'http://gems.dev.mas.local'
gem 'rio', '1.9.1', source: 'http://gems.dev.mas.local'
gem 'savings_calculator', '~> 1.6.0'
gem 'timelines', '~> 1.4.0', git: 'git@github.com:moneyadviceservice/timelines.git', branch: '7693-canonical-tags'
