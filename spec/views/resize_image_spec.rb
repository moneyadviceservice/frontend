RSpec.describe 'shared/_article_promos', type: :view do
  before do
      ...
      [{"heading"=>"Plug those money leaks", "image"=>"https://example.com/MoneyLeaks.jpg", "url"=>"https://example.com/blog", "label"=>"blog", "content"=>"Do you know the most common ways you waste money?" }]
		end
