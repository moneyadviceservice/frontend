...
gem 'cream', '2.1.8'
gem 'dough-ruby', git: 'git@github.com:moneyadviceservice/dough.git', branch: 'Third-Party-Cookie-Control', ref: '7d59f76'
...
gem 'debt_free_day_calculator', git: 'git@github.com:moneyadviceservice/debt_free_day_calculator.git', branch: '11920_Third-Party-Cookies', ref: '1a64731'
# gem 'debt_free_day_calculator', path: '../debt-free-day-calculator'
gem 'debt_test', '~> 1.9.0'
