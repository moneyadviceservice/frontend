...
gem 'debt_free_day_calculator', '~> 2.3.3'
gem 'debt_test', '~> 1.7.3'
...
gem 'timelines', '~> 1.5.0'
gem 'universal_credit', git: 'git@github.com:moneyadviceservice/universal_credit', branch: '8545_Add-devolved-nation-selection', ref: '7d5374a848a5258b7626077a6a416bfcce8c3c16'
gem 'wpcc', '1.11.14'
