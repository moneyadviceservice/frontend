...
# Tools
gem 'action_plans', git: 'git@github.com:moneyadviceservice/action_plans.git', branch: '12641_Add-Dough-PostMessages_v5.45', ref: 'ecee836'
...
gem 'feedback', '~> 0.5.1'
gem 'mortgage_calculator', git: 'git@github.com:moneyadviceservice/mortgage_calculator.git', branch: 'feature/ntt_moneyhelper_reskin', ref: 'e23d447'
