...
# gem 'debt_advice_locator', '3.9.0'
gem 'debt_advice_locator', git: 'git@github.com:moneyadviceservice/debt-advice-locator', branch: '10702_JS-components-initialisation', ref: '23a7422'
